class BookmarkPreview {
    ...
    updatePosition(element) {
        ...
        // Use offsetWidth/Height if visible, otherwise fallback to CSS values or defaults
        // Since it's display: none, we might need to rely on hardcoded or temporary display
        // But better to just use the values we know or make them constants matching CSS
